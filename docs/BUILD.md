...
## Toolchain used for 1.0.0 and 1.1.0-rc4
...
python scripts/build.py `
  ...
  --output work/Oniimai-Kanade-API102-1.1.0-rc4.apk
```
...
python scripts/audit_release.py --apk work/Oniimai-Kanade-API102-1.1.0-rc4.apk
```
