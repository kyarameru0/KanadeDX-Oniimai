...
Current **1.1.0-rc1 / KanadeDX 1.65** observations are recorded in [Compatibility 1.65](COMPATIBILITY-1.65.md). The following is the historical **1.0.0** validation record.
