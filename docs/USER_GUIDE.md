...
Version 1.1.0-rc1 adds KanadeDX-260721.1649 (1.65) and preserves the 260207.0635 (1.60) profile. The published 1.0.0 APK supports only 1.60. See [compatibility and update instructions](COMPATIBILITY-1.65.md).
...
| Only phone cards fail | System NFC, active game scan, antenna position, MIFARE Classic support |
